...
public class BladeActionDisplayContext
	...
	public Menu getMenu() throws PortalException {
		...
		if (_showAction()) {
			...
			jsMenuItem.setLabel("Convert to Web Content");
	...
	public List<ToolbarItem> getToolbarItems() throws PortalException {
		...
		jsToolbarItem.setLabel("Convert to Web Content");
	...
	private String _getOnclick() {
		...
		long dlFileId = fileVersion.getFileEntryId();
		...
		portletURL.setParameter("fileEntryId", String.valueOf(dlFileId));
		try {
